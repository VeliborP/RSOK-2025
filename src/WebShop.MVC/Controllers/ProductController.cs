...
namespace WebShop.MVC.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Name,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Name,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
